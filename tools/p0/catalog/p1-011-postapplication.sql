...
target_functions(schema_name, function_name, identity_args) AS (
  VALUES
    ...
    ('public','enforce_fee_calculation_integrity',''),
    ('public','prevent_fee_calculation_mutation',''),
    ('public','enforce_payment_transaction_integrity',''),
    ('public','enforce_payment_request_consistency',''),
    ('public','enforce_payment_consultation_consistency',''),
    ('public','enforce_payment_regulatory_mapping_consistency',''),
    ('public','enforce_ledger_entry_integrity',''),
    ('public','prevent_ledger_entry_mutation',''),
    ('public','prevent_audit_event_mutation',''),
    ('public','enforce_retention_rule_integrity',''),
    ('public','enforce_legal_hold_integrity','')
),
